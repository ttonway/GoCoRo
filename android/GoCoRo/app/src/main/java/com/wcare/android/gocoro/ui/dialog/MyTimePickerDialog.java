...
public class MyTimePickerDialog extends AlertDialog implements OnClickListener,
    ...
    private final NumberPicker mStatusPicker;
    ...
    public MyTimePickerDialog(final Context context,
        ...
        mStatusPicker = (NumberPicker) view.findViewById(R.id.statusPicker);
    ...
    public NumberPicker getStatusPicker() {
        return mStatusPicker;
    }

    public void disableHourPicker() {
        mTimePicker.getHourPicker().setVisibility(View.GONE);
    }
